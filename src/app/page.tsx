        ...
        <div className="space-y-4">
          <Link href="/college" className="block">
            <div className="border-2 border-black rounded-lg p-8 hover:bg-gray-50 transition-colors cursor-pointer">
              <h2 className="text-3xl font-semibold mb-2">COLLÈGE</h2>
              <p className="text-gray-600 text-lg">7ème • 8ème • 9ème</p>
            </div>
          </Link>
          
          <Link href="/lycee" className="block">
            <div className="border-2 border-black rounded-lg p-8 hover:bg-gray-50 transition-colors cursor-pointer">
              <h2 className="text-3xl font-semibold mb-2">LYCÉE</h2>
              <p className="text-gray-600 text-lg">1ère • 2ème • 3ème • 4ème</p>
            </div>
          </Link>
        </div>
      </div>
